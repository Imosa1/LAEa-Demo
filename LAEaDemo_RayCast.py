...
if __name__ == "__main__":
    ...
    while running:
        ...
        renderTime.append(time.time()-workStart)
        frameTime.append(time.time()-frameStart)

        clock.tick(2)

    print("average work time :",ma.fsum(renderTime)/len(renderTime))
    print("average frame time:",ma.fsum(frameTime)/len(frameTime))
